-- Script SQL para popular o banco de dados do Sistema de Abrigos
...
('013.579.246-80', 'Helena Martins Souza', '1993-09-10', '(85) 90000-1112', NULL, 'helena.souza@email.com', 'Rua Nova', '1200', 'Varjota', 'Fortaleza', 'CE', '60125-001', 'FUNCIONARIO', TRUE);;
-- INSERIR ACOLHIDOS
...
-- Verificar dados q ja tão no banco
...
-- Comandos abaixo para resovler alguns problemas que surgiram após alterações no modelo e teste de inserção de dados
...
ALTER TABLE acolhidos ADD COLUMN IF NOT EXISTS possui_deficiencia BOOLEAN DEFAULT FALSE;
ALTER TABLE acolhidos ADD COLUMN IF NOT EXISTS tipo_deficiencia VARCHAR(200);

ALTER TABLE acolhimentos ADD COLUMN IF NOT EXISTS motivo_saida VARCHAR(100);
ALTER TABLE acolhimentos ADD COLUMN IF NOT EXISTS observacoes_saida TEXT;
ALTER TABLE acolhimentos ADD COLUMN IF NOT EXISTS data_criacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE atendimentos ADD COLUMN IF NOT EXISTS data_criacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE familiares ADD COLUMN IF NOT EXISTS telefone_secundario VARCHAR(15);
ALTER TABLE familiares ADD COLUMN IF NOT EXISTS email VARCHAR(100);
ALTER TABLE familiares ADD COLUMN IF NOT EXISTS endereco VARCHAR(500);
ALTER TABLE familiares ADD COLUMN IF NOT EXISTS data_criacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

INSERT INTO pessoas (
    cpf, nome, data_nascimento, telefone_principal, telefone_secundario,
    email, endereco_rua, endereco_numero, endereco_bairro, endereco_cidade,
    endereco_estado, endereco_cep, tipo_pessoa, ativo
) VALUES (
    '013.579.246-82', 'Helena Martins Souza', '1993-09-10', 
    '(85) 90000-1114', NULL, 'helena.souza2@email.com',
    'Rua Nova', '1200', 'Varjota', 'Fortaleza', 'CE', '60125-001',
    'FUNCIONARIO', TRUE
);

INSERT INTO funcionarios (
    id_pessoa, matricula, cargo, data_admissao, salario, turno, status_funcionario
) VALUES (
    11, 'FUNC012', 'Assistente Administrativa', '2024-01-10', 3200.00, 'TARDE', 'ATIVO'
);
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints 
                   WHERE constraint_name = 'fk_funcionario_abrigo') THEN
